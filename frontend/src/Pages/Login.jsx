...
//   const { login } = useAuth();
//   const { setActivePage, setLoggedIn, setRole } = useActivePage();
...
//       setLoggedIn(true);
//       setRole(storedRole);
//       setActivePage(storedRole === "Admin" ? "Admin" : "dashboard");
//     }
//   }, []);
...
//   // ----------------------
//   const variants = {
//     enter: (dir) => ({ x: dir > 0 ? 300 : -300, opacity: 0, position: "absolute", width: "100%" }),
//     center: { x: 0, opacity: 1, position: "relative", width: "100%" },
//     exit: (dir) => ({ x: dir < 0 ? 300 : -300, opacity: 0, position: "absolute", width: "100%" }),
//   };
...
//           {isLogin ? (
//             // ---------- LOGIN FORM ----------
//             <motion.div key="login" custom={1} variants={variants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.5 }}>
//               <h1 className="text-4xl font-extrabold text-blue-800 mb-6 text-center tracking-wide" style={{ fontFamily: "'Dancing Script', cursive" }}>Login</h1>

//               {loginError && <div className="bg-red-100 text-red-700 p-3 rounded mb-4 text-center font-semibold">{loginError}</div>}

//               {forgotPassword ? (
//                 <ForgotPassword onBack={() => setForgotPassword(false)} />
//               ) : (
//                 <form onSubmit={handleLoginSubmit} className="flex flex-col space-y-4">
//                   <InputField type="email" placeholder="Email" value={loginEmail} onChange={(e) => setLoginEmail(e.target.value)} />
//                   <InputField type="password" placeholder="Password" value={loginPassword} onChange={(e) => setLoginPassword(e.target.value)} />
...
//                     <button type="button" onClick={() => setForgotPassword(true)} className="text-sm text-blue-600 hover:underline font-semibold focus:outline-none">Forgot Password?</button>
//                   </div>
//                 </form>
//               )}

//               <p className="mt-6 text-center text-blue-700 font-semibold cursor-pointer hover:underline select-none" onClick={() => setIsLogin(false)}>New user? Register here</p>
//             </motion.div>
//           ) : (
//             // ---------- REGISTER FORM ----------
//             <motion.div key="register" custom={-1} variants={variants} initial="enter" animate="center" exit="exit" transition={{ duration: 0.5 }}>
//               <h1 className="text-4xl font-extrabold text-blue-800 mb-6 text-center tracking-wide" style={{ fontFamily: "'Dancing Script', cursive" }}>New Registration</h1>

//               {regError && <div className="bg-red-100 text-red-700 p-3 rounded mb-4 text-center font-semibold">{regError}</div>}

//               <form onSubmit={handleRegSubmit} className="flex flex-col space-y-4">
//                 <InputField placeholder="Full Name" value={regName} onChange={(e) => setRegName(e.target.value)} />
//                 <InputField type="email" placeholder="Email" value={regEmail} onChange={(e) => setRegEmail(e.target.value)} />
//                 <InputField type="password" placeholder="Password" value={regPassword} onChange={(e) => setRegPassword(e.target.value)} />
//                 <InputField type="password" placeholder="Confirm Password" value={regConfirmPassword} onChange={(e) => setRegConfirmPassword(e.target.value)} />
//                 <select value={regRole} onChange={(e) => setRegRole(e.target.value)} className="w-full px-4 py-3 rounded-lg border border-blue-300 bg-white text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
//                   <option value="Customer">Customer</option>
//                   <option value="Admin">Admin</option>
//                 </select>
//                 <button type="submit" className="w-full bg-blue-600 text-white font-semibold py-3 rounded-lg hover:bg-blue-700 transition">Register</button>
//               </form>

//               <div className="mt-6 text-center text-sm text-gray-600">
//                 Already signed in?{" "}
//                 <button onClick={() => setIsLogin(true)} className="text-blue-600 hover:text-blue-800 font-semibold focus:outline-none">Login here</button>
//               </div>
//             </motion.div>
//           )}
//         </AnimatePresence>
