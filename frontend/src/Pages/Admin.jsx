...
//     { name: "promo_codes", label: "Promo Codes", icon: <FaUser /> },
//   ];
...
//           "http://localhost:5000/api/admin/customers/count",
...
//           "http://localhost:5000/api/admin/orders/count",
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
...
//         // Orders by Date (All)
//         const ordersByDateRes = await axios.get(
//           "http://localhost:5000/api/admin/orders/daily-stats",
//           { headers: { Authorization: `Bearer ${token}` } }
//         );
//         setOrdersByDate(ordersByDateRes.data);

//         // Orders by Date (Completed)
//         const completedByDateRes = await axios.get(
...
//       {/* Sidebar */}
//       <aside className="w-64 bg-gradient-to-b from-blue-700 to-blue-500 text-white flex flex-col p-6 space-y-4">
...
//             <h3 className="text-2xl font-bold mb-6 text-blue-600">Orders</h3>
//             <AdminOrders />
//           </div>
//         )}
...
//             </h3>
//             <p>Manage measurement instructions for all dress types.</p>
//           </div>
//         )}
//         {activeSection === "inventory" && <AdminInventory />}
//         {activeSection === "promo_codes" && <PromoCodes />}
...
//             </p>
//             <button className="mt-6 px-5 py-2 bg-red-500 text-white rounded hover:bg-red-600">
//               Logout
//             </button>
//           </div>
//         )}
...
//   );
// }
// src/Subpages/AdminDashboard.jsx
